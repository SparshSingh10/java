public class switch1{
    ...
    public static String getQuarter(String month){
        return switch (month.toUpperCase()){
            ...
            // case "JAN", "FEB", "MARCH" ->{yield "1st";} yeild can be used anywher when multiple lines neede due calculation etc.
            ...
            default ->{
                ...
                yield ans;
                // yield: Used when you want to perform multiple actions inside a case block and return a value.
            }
        };
    }
